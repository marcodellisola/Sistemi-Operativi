...
void filtro(int ds_queue_gen_filter, int ds_queue_filter_checksum){
        ...
        for (i=0; i<NUM_MESSAGES; i++){
                ...
                ret = /* TODO: ricevere il messaggio dai processi generatori consumatori */msgrcv(ds_queue_gen_filter,&mess,sizeof(message)-sizeof(long),MSG_TYPE,0);
